...
LOG="kitti/logs/comp_kitti_ped_cyc_$2_vgg16.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu $1 \
  ...
  --net output/kitti_ped_cyc_$2/kitti_ped_cyc_trainval/vgg16_frcn_kitti_iter_40000.caffemodel \
