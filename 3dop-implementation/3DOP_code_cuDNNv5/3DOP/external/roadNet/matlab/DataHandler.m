classdef DataHandler < Introspector
    properties
        ...
        SET_TEST = 'object_testing'; % KITTI object detection dataset
%         SET_TEST = 'object_testing';
    ...
    methods
        ...
        function cam = getCam(self, imset, id)
            ...
            calibPath = fullfile(calib_dir, sprintf('%s.txt', id));
            [~, K, calib] = loadCalibration(calibPath);
            [~,~,tl] = KRt_from_P(calib.P_rect{3});  % left camera
