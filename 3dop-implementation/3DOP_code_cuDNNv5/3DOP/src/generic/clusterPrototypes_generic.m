function template_cuboids = clusterPrototypes_generic(db)
...
% only pick the top 9 templates
[~, ids] = sort([cluster_center.count], 'descend');
template_cuboids = cluster_center(ids(1:9));
