function priorModel = computePrior_generic(trainset)
% compute prior parameters

cfg = kitti_config_generic(trainset);

folder = 'data/models-generic';
mkdir_if_missing(folder);
prior_file = sprintf('%s/prior_%s.mat', folder, trainset);
...
template_cuboids = clusterPrototypes_generic(db);
