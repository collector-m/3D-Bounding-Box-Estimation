...
label_dir_2 = fullfile(root_dir, 'models-to-test','output-original-3DOP','out');
label_dir_3 = fullfile(root_dir, 'models-to-test','output-rajat-3DOP','out');
label_dir_4 = fullfile(root_dir, 'models-to-test','output-rajat-3DOP-120000','out');
...
while 1
  ...
  visualization_all_images_3DOP('update',image_dir,h, img_idx,nimages,data_set, count);
